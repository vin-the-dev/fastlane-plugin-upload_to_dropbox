...
module Fastlane
  module Actions
    module SharedValues
      DROPBOX_UPLOADED_FILE_URL = :DROPBOX_UPLOADED_FILE_URL
    end
    class UploadToDropboxAction < Action
      ...
      def self.run(params)
        ...
        #delete file
        begin
          UI.message "Deleting file"
          client.delete(destination_path(params))
          UI.message "Deleting file success"
        rescue 
          UI.message "File not present"
        end
        #delete file end
        output_file = nil
      ...
      def self.upload(client, file_path, destination_path, write_mode)
        begin
          ...
          # result = client.get_shared_link_metadata destination_path 
          # UI.success(client.methods.sort)
      ...
      def self.request_token(app_key, app_secret)
        sh("open 'https://www.dropbox.com/1/oauth2/authorize?response_type=code&require_role=personal&client_id=#{app_key}'")
      ...
      def self.available_options
        [
          ...
          FastlaneCore::ConfigItem.new(key: :keychain_password,
                                       ...
                                       type: String,
                                       optional: true),
          FastlaneCore::ConfigItem.new(key: :is_ipa,
                                       env_name: 'DROPBOX_IS_IPA',
